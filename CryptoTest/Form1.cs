...
namespace CryptoTest
{
    public partial class Form1 : Form
    {
        ...
        const string SrcFolder = @"C:\Users\Ferris\Downloads";

        // Public key file
        const string PubKeyFile = @"c:\encrypt\rsaPublicKey.txt";
        // Private key file
        const string PrivateKeyFile = @"c:\encrypt\rsaPrivateKey.txt";
